-- =====================================================
-- MIGRATION: RESTRICT MEMBER VISIBILITY
-- =====================================================
-- Date: 2025-12-13
-- Description: Only organization members can see member details
-- =====================================================

-- Update function to check if user is a member before returning details
